...
Presentation.prototype =
  {
      ...
      $("#image-input").on("blur keyup change", function(){
        ...
        if(me.isValidUrl(imageUrl)){
          ...
          $(imageTmp).on("load", function(){
            ...
            selector_preview_image.css("width", imageTmp.width).css('height', imageTmp.height);
          });
        }else{
    ...
    resetSaveButtonText: function(){
      ...
      setTimeout(function(){
        $("#save-presentation-panel").html('<div class="sb-nav-link-icon"><i class=\"fas fa-save\"></i></div>Sauvegarder');
      }, 1000);
    },
    ...
    toggleNightMode: function(){
      ...
      if(me.nightMode === false){
        ...
        selector_panorama_navbar.removeClass("transform-controls-holder-night");
